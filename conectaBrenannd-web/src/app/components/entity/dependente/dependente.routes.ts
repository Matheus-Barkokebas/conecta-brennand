...
export const DEPENDENTE_ROUTES: Routes = [
  { path: 'new', component: NewDependenteComponent, data: { title: 'Cadastrar Dependente' } },
  { path: 'meus', component: ListDependenteComponent, data: { title: 'Listar Dependente' } },
  { path: 'edit/:id', component: EditDependenteComponent, data: { title: 'Editar Dependente' } },
];
