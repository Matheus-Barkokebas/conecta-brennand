...
export const GRUPO_ROUTES: Routes = [
  { path: 'new', component: NewGrupoComponent, data: { title: 'Cadastrar Grupo' } },
  { path: 'meus', component: ListGrupoComponent, data: { title: 'Listar Grupo' } },
  { path: 'edit/:id', component: EditGrupoComponent, data: { title: 'Editar Grupo' } },
  { path: 'homeGrupos', component: GrupoHomeComponent, data: { title: 'Listar Grupo' } },
];
