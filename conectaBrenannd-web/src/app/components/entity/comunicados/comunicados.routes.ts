...
export const COMUNICADOS_ROUTES: Routes = [
  { path: 'new', component: NewComunicadosComponent, data: { title: 'Cadastrar Comunicado' } },
  { path: 'list', component: ListComunicadosComponent, data: { title: 'Listar Comunicado' } },
  { path: 'edit/:id', component: EditComunicadosComponent, data: { title: 'Editar Comunicado' } },
];
