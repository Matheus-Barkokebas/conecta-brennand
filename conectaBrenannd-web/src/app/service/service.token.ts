...
export const SERVICES_TOKEN = {
  HTTP: {
    ...
    INGRESSO: new InjectionToken<IIngressoService>(
      'SERVICES_TOKEN.HTTP.INGRESSO'
    ),
    GRUPO: new InjectionToken<IGrupoService>('SERVICES_TOKEN.HTTP.GRUPO'),
    DEPENDENTE: new InjectionToken<IDependenteService>(
      'SERVICES_TOKEN.HTTP.DEPENDENTE'
    ),
    COMUNICADOS: new InjectionToken<IComunicadosService>(
      'SERVICES_TOKEN.HTTP.COMUNICADOS'
    ),
    PESQUISA: new InjectionToken<IPesquisaService>(
      'SERVICES_TOKEN.HTTP.PESQUISA'
    ),
  },
